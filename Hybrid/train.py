...
if __name__ == "__main__":
    ...
    graphplt(train_loss1,train_loss2,train_loss3,train_loss4, "Train_loss ", "No. of epochs", "Loss During Training")
    graphplt(train_acc1,train_acc2,train_acc3,train_acc4,"Train_Accuracy ", "No. of epochs", "Accuracy During Training")
    graphplt(val_loss1,val_loss2,val_loss3,val_loss4, "Validation_loss ", "No. of epochs", "Loss During Validation")
    graphplt(val_acc1,val_acc2,val_acc3,val_acc4 ,"Validation_Accuracy ", "No. of epochs", "Accuracy During Validation")
    graphplt(test_loss1,test_loss2,test_loss3,test_loss4,"Testing_loss  ", "No. of epochs", "Loss During Testing")
    graphplt(test_acc1,test_acc2,test_acc3,test_acc4, "Testing_Accuracy  ", "No. of epochs", "Accuracy During Testing")
